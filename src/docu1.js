...
export default function Docu1() 
{
    ...
    const uploadDocu = async() =>{
        ...
        const response = await axios.post("http://localhost/react_sub_php/api/file.php",formData,{ headers:{'Content-Type':"multipart/form-data"},
    ...
    useEffect(()=>{
        ...
        {
            const reqData = await fetch("http://localhost/react_sub_php/api/file.php");
    ...
    const onButtonClick = (event) => {
      ...
      fetch( `./files_doc/${filename}` ).then(response => {
  ...
  return (
    ...
    <p style={{height:"2.5vw",marginLeft:"12vw" , paddingTop:"0.2vw"  , fontStyle: "normal", fontWeight: "bold" ,fontSize: "1.5vw"  , fontStyle: "normal", fontWeight: "bold"  , color: "#FB4E0B" , width:"85.2vw" , border:"1px solid rgba(0,0,0,0.15)" , marginTop:"-1.3vw"}}>Documentation</p>
      
      <p style={{ textAlign:"center", height:"5vw",marginLeft:"42vw" , paddingTop:"0.5vw"  , fontStyle: "normal", fontWeight: "bold" ,fontSize: "1vw"  , fontStyle: "normal", fontWeight: "bold"  , color: "#FB4E0B" , width:"25vw" , marginTop:"-1vw"}}>File Sharing</p>
      
      <p style={{ textAlign:"center", height:"2vw",marginLeft:"17.8vw" , paddingTop:"0.5vw"  , fontStyle: "normal", fontWeight: "bold" ,fontSize: "1vw"  , fontStyle: "normal", fontWeight: "bold"  , color: "#FB4E0B" , width:"25vw" , marginTop:"2vw" , textAlign:"left"}}>Upload New Document</p>
      
      <Card style={{height:"9vw" , width:"79vw" , border:"1px solid rgba(0,0,0,0.15)" , marginLeft:"17.5vw" , marginTop:"0.5vw"}}>
        ...
        <div style={{paddingLeft:"0vw", width:"26vw" ,fontStyle: "normal" ,paddingTop:"0vw",marginLeft:"1vw" , border:"1px solid rgba(0,0,0,0.15)",borderRight:"1px solid rgba(0,0,0,0.15)",borderLeft:"1px solid rgba(0,0,0,0.15)" , marginTop:"0vw" , marginRight:"1vw" , height:"5vw" ,width:"51vw"}}>
         <div style={{display:"flex"}}><div style={{border:"1px solid rgba(0,0,0,0.15)" , paddingLeft:"1vw" , paddingRight:"1vw" , marginLeft:"0.5vw" , marginTop:"0.5vw" , textAlign:"center" , fontSize:"1.02vw" , width:"12.5vw"}}>Document Description</div><div style={{marginLeft:"0vw" , textAlign:"center", border:"1px solid rgba(0,0,0,0.15)" , marginTop:"0.5vw", paddingLeft:"1vw" , paddingRight:"1vw", width:"12.5vw" , fontSize:"1.02vw"}}>SPOC Name</div><div style={{marginLeft:"0vw", textAlign:"center", marginTop:"0.5vw" , width:"12.5vw", border:"1px solid rgba(0,0,0,0.15)" , paddingLeft:"1vw" , paddingRight:"1vw" , fontSize:"1.02vw"}}>Attachment</div><div style={{ textAlign:"center",width:"12vw", marginTop:"0.5vw" ,marginLeft:"0vw" , border:"1px solid rgba(0,0,0,0.15)" , paddingLeft:"1vw" , paddingRight:"1vw" , fontSize:"1.02vw"}}>IDs to Share </div></div>
      ...
      <p style={{ textAlign:"center", height:"2vw",marginLeft:"17.8vw" , paddingTop:"0.5vw"  , fontStyle: "normal", fontWeight: "bold" ,fontSize: "1vw"  , fontStyle: "normal", fontWeight: "bold"  , color: "#FB4E0B" , width:"25vw" , marginTop:"1vw" , textAlign:"left"}}>View Existing Document</p>

      <Card style={{display:"flex" ,marginLeft:"17.5vw" , width:"79vw" , border:"1px solid rgba(0,0,0,0.15)" , marginTop:"1vw" , color:"red"}}><i style={{color:"#A1AEB7" , marginTop:"0.2vw" , marginLeft:"-76vw" }} class="bi bi-search" ></i>
      <input
        type="search"
        value={name}
